...
#'
#' @description A shiny Module for the About tab. Contains only static content
#'   (team info, citation, version history, changelog) — no server logic needed.
#'
...
mod_11_about_ui <- function(id) {
  ...
  tabPanel("About",
    ...
    br(),
    a("ShinyGO V0.82, ", href = "http://bioinformatics.sdstate.edu/go82/"),
    "based on Ensembl Release 104, archived on Sept 5, 2025",
    br(),
    a("ShinyGO V0.81, ", href = "http://bioinformatics.sdstate.edu/go81/"),
    "based on Ensembl Release 104, archived on Feb. 3, 2025",
    br(),
    a("ShinyGO V0.80, ", href = "http://bioinformatics.sdstate.edu/go80/"),
    ...
    br(),
    a("ShinyGO V0.76, ", href = "http://bioinformatics.sdstate.edu/go76/"),
    "based on Ensembl Release 104 with revision, archived on September 2, 2022",
    br(),
    a("ShinyGO V0.75, ", href = "http://bioinformatics.sdstate.edu/go75/"),
    "based on Ensembl Release 104 with revision, archived on April 4, 2022",
    br(),
    a("ShinyGO V0.74, ", href = "http://bioinformatics.sdstate.edu/go74/"),
    "based on Ensembl Release 104, archived on Feb. 8, 2022",
    br(),
    a("ShinyGO V0.65, ", href = "http://bioinformatics.sdstate.edu/go65/"),
    "based on Ensembl Release 103, archived on Oct. 15, 2021",
    br(),
    a("ShinyGO V0.61, ", href = "http://bioinformatics.sdstate.edu/go61/"),
    "based on Ensembl Release 96, archived on May 23, 2020",
    br(),
    a("ShinyGO V0.60, ", href = "http://bioinformatics.sdstate.edu/go60/"),
    "based on Ensembl Release version 96, archived on Nov 6, 2019",
    br(),
    a("ShinyGO V0.51, ", href = "http://bioinformatics.sdstate.edu/go51/"),
    "based on Ensembl Release version 95, archived on May 20, 2019",
    br(),
    a("ShinyGO V0.50, ", href = "http://bioinformatics.sdstate.edu/go50/"),
    "based on Ensembl Release version 92, archived on March 29, 2019",
    br(),
    a("ShinyGO V0.41, ", href = "http://bioinformatics.sdstate.edu/go41/"),
